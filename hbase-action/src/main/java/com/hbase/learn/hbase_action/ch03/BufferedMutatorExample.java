...
public class BufferedMutatorExample {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			put1.addColumn(Bytes.toBytes("col1"), Bytes.toBytes("id"), Bytes.toBytes(String.valueOf(i)));
			put1.addColumn(Bytes.toBytes("col1"), Bytes.toBytes("name"), Bytes.toBytes("test"+ String.valueOf(i)));
			put1.addColumn(Bytes.toBytes("col1"), Bytes.toBytes("sex"), Bytes.toBytes("male"));
