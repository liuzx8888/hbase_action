...
import org.apache.hadoop.hbase.protobuf.generated.ComparatorProtos.Comparator;
...
public class LoadWithTableDescriptorExample {
	...
	public static void main(String[] args) throws Exception {
		...
		htd.setValue("COPROCESSOR$1", "'hdfs://hadoop1:8020/user/hbase/customCoprocessor/test.jar" + "|"
